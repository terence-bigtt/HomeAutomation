...
def get_configured_ip_cams():
    ...
    ipcam.append(IpCamDevice("Room1", "room at the floor", ip="192.168.1.50", cam_user= ipcam_conf["payload"].get("user"),
                         capture_path="tmpfs/auto.jpg", cam_password= ipcam_conf["payload"].get("pwd"), device_id="2", authentication="BASIC"))

    return {cam.device_id: cam for cam in ipcam}
